...
export const remove = (url, options) =>
  myFetch(url, generateOptions({ ...options, method: 'DELETE' }));
export const post = (url, body, options) =>
  myFetch(url, generateOptions({ ...options, body, method: 'POST' }));
export const put = (url, body, options) =>
  myFetch(url, generateOptions({ ...options, body, method: 'PUT' }));
export const patch = (url, body, options) =>
  myFetch(url, generateOptions({ ...options, body, method: 'PATCH' }));
